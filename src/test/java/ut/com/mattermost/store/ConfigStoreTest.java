...
public class ConfigStoreTest extends TestCase
{
    ...
    public void setUp() throws Exception {
        ...
        mConfigStore = new ConfigStoreImpl(pluginSettingsFactory);
    }
    ...
    public void testGetWebhookURL() {
        ...
        String output = mConfigStore.getWebhookURL();
        assertEquals("Webhook URL does not match.", "https://test.webhook.url", output);
    }

    @Test
    public void testSetWebhookURL() {
        mConfigStore.setWebhookURL("https://test.webhook.url");
